    ...
    ImageFrameWithLoading.prototype.render = function () {
        ...
        return (React.createElement(StretchingDiv, null,
            this.state.image != null ?
                React.createElement(ImageFrame_1.default, { viewTransform: this.props.viewTransform, clearColor: this.props.clearColor, exposure: this.props.exposure, gamma: this.props.gamma, offset: this.props.offset, image: this.state.image, ref: function (frame) { return _this.imageFrame = frame; }, allowMovement: this.props.allowMovement, enableMouseEvents: this.props.enableMouseEvents })
                : null,
            this.state.isLoading ? React.createElement(LoadingOverlay, { className: "jeri-overlay" }, "Downloading ...") : null,
            this.state.errorMsg ? React.createElement(LoadingOverlay, { className: "jeri-overlay" }, this.state.errorMsg) : null));
    };
    /**
