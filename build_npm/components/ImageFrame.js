...
var ImageFrame = /** @class */ (function (_super) {
    ...
    ImageFrame.prototype.render = function () {
        ...
        return (React.createElement(StretchingDiv, null,
            React.createElement(StretchingCanvas, { ref: function (x) { return _this.imageLayerElement = x; } }),
            React.createElement(StretchingCanvas, { ref: function (x) { return _this.textLayerElement = x; } }),
            React.createElement(StretchingCanvas, { ref: function (x) { return _this.mouseLayerElement = x; } })));
    };
