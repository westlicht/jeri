...
exports.NavRow = function (_a) {
    ...
    return (React.createElement(NavRowDiv, { className: "jeri-nav-row" }, row.children.map(function (child, i) { return (React.createElement(NavLink, { onClick: function () { return handleClick(child.title); }, key: child.title, active: child.title === selection, className: child.title === selection ? 'jeri-nav-link selected' : 'jeri-nav-link' },
        i === 0 ? titlesInRow[i] : trimmedTitles[i],
        active && i < 10 ? React.createElement(NavLinkNumber, { className: "jeri-nav-link-number" }, (i + 1) % 10) : null)); })));
};
